...
class VideoVisualizer:
    ...
    def draw_instance_predictions(self, frame, predictions, cols=None, fontsize=None):
        """
        ...
        frame_visualizer = Visualizer(frame, self.metadata, fontsize=fontsize)
        ...
        frame_visualizer.overlay_instances(
            ...
            assigned_colors=cols if cols else assigned_colors,
            alpha=alpha,
        )
